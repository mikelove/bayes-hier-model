...
subtitle: For Cell-Type-Specific Gene Regulation
...
> 1. A **parametric model** for regulation
    - some parameter will represent an abstract relationship
	- e.g. SNP $\rightarrow$ expression, or SNP $\rightarrow$ chromatin accessibility
> 2. A **hierarchy** to compare these relationships across cell types
> 3. Specify *arbitrary* **distributions** for the parameters, tying them together
> 4. **Bayes** theory and computational frameworks to make inference
...
# Bayesian Hierarchical Models in eQTL and GWAS
